...
<div class="widget">
    <h2><?= $this->lang->line('bestseller')?></h2>
    <div class="body">
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="assets/images/blank.gif" data-echo="<?php echo base_url()?>assets/front/images/products/light6.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="assets/images/blank.gif" data-echo="<?php echo base_url()?>assets/front/images/products/light7.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">                        
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="assets/images/blank.gif" data-echo="<?php echo base_url()?>assets/front/images/products/light8.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="assets/images/blank.gif" data-echo="<?php echo base_url()?>assets/front/images/products/light9.jpg" />
                        </a>
                    </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-4 ">
<div class="widget">
    <h2><?= $this->lang->line('product_other')?></h2>
    <div class="body">
        <ul>
            <li>
                <div class="row">
